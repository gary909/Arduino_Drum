...
Sample <KICK01_NUM_CELLS, AUDIO_RATE, INTERP_LINEAR> aSample(KICK01_DATA);
float recorded_pitch = (float) KICK01_SAMPLERATE / (float) KICK01_NUM_CELLS;
